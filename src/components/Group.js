...
import { Segment, Header, Image, Divider, Card, Container, Grid, Icon, Label, Button } from 'semantic-ui-react';
...
class Group extends React.Component {
  ...
  render () {
    ...
    if (this.state.editFormOpen) {
      return (
        <Container text>
          <Segment fluid content='EDIT FORM OPEN' />
        </Container>
      )
    } else {
      return (
        <Container text>
          <Segment fluid>
            <Button floated='right' size='tiny' basic>
              <Icon name='edit' />
              Edit
            </Button>
